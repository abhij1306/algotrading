...
1. [Done] Update database to use DB_FORMAT (if not already)
2. [Done] Update parquet files to use DB_FORMAT
3. [Done] Add symbol_master service
4. [Done] Update all API layers to convert at boundaries
5. [Done] Update WebSocket service to use symbol_master
6. [Done] Update frontend to display DB_FORMAT but subscribe with FYERS_FORMAT
