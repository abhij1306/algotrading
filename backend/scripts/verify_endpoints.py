...
class EndpointTester:
    ...
    def run_all_tests(self):
        ...
        print("\n🔍 SCREENER ENDPOINTS")
        print("-"*100)
        self.test_endpoint("Screener Indices", "GET", "/api/screener/indices", expected_status=200)
        self.test_endpoint("Screener Results", "GET", "/api/screener/results?universe=NIFTY50&page=1&limit=25", expected_status=200)
