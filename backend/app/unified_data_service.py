...
class UnifiedDataService:
    ...
    def _get_from_cold_layer(self, symbol: str, start_date: str, end_date: str) -> pd.DataFrame | None:
    ...
    def _get_from_warm_layer(self, symbol: str, start_date: str, end_date: str) -> pd.DataFrame | None:
    ...
    def _get_from_hot_layer(self, symbol: str, start_date: str, end_date: str) -> pd.DataFrame | None:
