...
class LiveOrder(Base):
    ...
    # Status
    status = Column(String(20), default='PENDING', index=True) # PENDING -> SUBMITTED -> FILLED / REJECTED / CANCELLED
    ...
    is_paper = Column(Integer, default=0)             # 1 = Paper, 0 = Live (using Integer for boolean compatibility if needed, else Boolean)
