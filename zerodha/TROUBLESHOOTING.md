...
Open this URL in browser (replace with your API key):
```
https://kite.zerodha.com/connect/login?v=3&api_key=wqz5ca8le4qses16
```
...
Run this Python command (replace REQUEST_TOKEN with your actual token):

```python
from kiteconnect import KiteConnect
import json

api_key = "wqz5ca8le4qses16"
api_secret = "9m18k1uhqw6wmrmwa1hxzz2h7v3lm3d2"
