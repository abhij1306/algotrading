...
>(({ className, ...props }, ref) => (
  <div
    ref={ref}
    className={cn(
      "rounded-xl border border-[var(--border-default)] p-4 space-y-3",
      className
    )}
    {...props}
  >
...
>(({ className, rows = 5, columns = 4, ...props }, ref) => (
  <div ref={ref} className={cn("space-y-2", className)} {...props}>
    {/* Header */}
    <div className="flex gap-4 p-2 border-b border-[var(--border-default)]">
...
// Skeleton Metric
const SkeletonMetric = React.forwardRef<
  HTMLDivElement,
  React.HTMLAttributes<HTMLDivElement>
>(({ className, ...props }, ref) => (
  <div
    ref={ref}
    className={cn(
      "rounded-xl border border-[var(--border-default)] p-4",
      className
    )}
    {...props}
  >
...
export { Skeleton, SkeletonCard, SkeletonTable, SkeletonMetric };
