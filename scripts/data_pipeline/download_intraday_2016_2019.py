"""
Download 5-Minute Intraday Data for Nifty50 and Bank Nifty from 2016 to 2019
"""
...
# Configuration
START_DATE = datetime(2016, 1, 1)  # From 2016
END_DATE = datetime(2019, 1, 1)    # Till 2019 (exclusive)
...
def main():
    """Download 5-minute intraday data for Nifty50 and Bank Nifty (2016-2019)"""
    print("\n" + "="*80)
    print("📊 DOWNLOADING 5-MINUTE INTRADAY DATA FROM FYERS (2016-2019)")
    print("="*80)
    ...
    for name, fyers_symbol in indices:
        print(f"\n📈 Downloading {name} (5-minute candles, 2016-2019)...")
        
        output_file = INTRADAY_OUTPUT_DIR / f"{name}_5min_2016_2019.csv"
    ...
    print("\n💡 Next Steps:")
    print("   1. Merge 2016-2019 data with 2019-present data")
    print("   2. Create complete historical 5-minute dataset")
    print("   3. Use for comprehensive backtesting (2016-2025)")
